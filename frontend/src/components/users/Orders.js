...
export default function Orders() {
    ...
    useEffect(() => {
        axios
            .post("/api/order/vorders", currVendor)
            .then(res => {
                setCards(res.data);
    ...
    function increment_status(props) {
        ...
        axios
            .post("/api/order/next_stage", newOrder)
            .then(res => {
                console.log(res.data);
                if (res.data.status === "accepted") {
                    axios
                        .post("/api/order/check_pend", currVendor)
                        .then(res => {
                            // console.log(res.data);
                            if (parseInt(res.data) > 10) {
                                axios
                                    .post("/api/order/make_pending", newOrder)
                                    .then(res => {
                                        console.log(res.data);
    ...
    function reject_order(props) {
        ...
        axios
            .post("/api/order/reject_order", newOrder)
            .then(res => {
                console.log(res.data);
            })
            .catch(function (error) {
        ...
        axios
            .post("/api/b_dashboard/add_money", currBuyer)
            .then(res => {
                console.log(res.data);
            })
            .catch(function (error) {
